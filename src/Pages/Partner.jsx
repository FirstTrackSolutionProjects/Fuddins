...
const Partner =()=>{
    return(
      ...
      <div className="flex gap-2 md:gap-20 items-center justify-center">
        ...
        <div className="text-white text-sm md:text-base bg-lime-600 w-fit h-fit px-2 py-1  md:px-10 md:py-3 rounded-md">LOGIN</div>
        <div className="text-white text-sm md:text-base bg-lime-600 w-fit h-fit px-2 py-1  md:px-8 md:py-3 rounded-md">CREATE ACCOUNT</div>
        <div className="hidden md:block text-white bg-lime-600 w-fit h-fit px-8 py-3 rounded-md">MEMBERSHIP PLANS</div>
        ...
        <div className=" md:w-1/2 mx-auto p-5 md:p-0">
            ...
            <div className="md:hidden flex gap-3">
                <img src="images/playstore.png" className="w-32"></img>
                <img src="images/app.png" className="w-32"></img>
            </div>
            <div className="flex md:gap-5">
                <div className="hidden md:block bg-lime-600 py-2 px-5 rounded-md">REGISTER YOUR STORE</div>
