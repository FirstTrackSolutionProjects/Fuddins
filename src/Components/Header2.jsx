  ...
  const [cartItems, setCartItems] = useState([]);
    ...
    return(
      <div>
        ...
        <Link to="/"><div><img src='images/logo.jpg' alt='no image' className='w-40 h-24 p-3'></img></div></Link>
            <nav className='w-full flex justify-between'>
                ...
                <div className='flex px-5 gap-8 items-center'>
                    ...
                    <div onClick={() => toggleSidebar('cart')} className='text-black p-1 items-center'><ShoppingCartIcon className='h-9 w-10 border-2 border-myGreen p-1 text-myGreen hover:bg-myGreen hover:text-white'/></div>
        ...
        <div onClick={() => toggleSidebar('cart')}  className='text-black p-1 items-center'><ShoppingCartIcon className='h-9 w-10 border-2 border-myGreen p-1 text-myGreen hover:bg-myGreen hover:text-white'/></div>
        <button onClick={() => toggleSidebar('menu')} className="text-myGreen  text-2xl">
...
{/* Sidebar for Menu */}
<div
        className={`z-20 fixed top-0 left-0 h-full w-80 bg-white text-black transform ${
      ...
      >
        ...
        <h2 className="p-4">Menu Items</h2>
        <ul>
          <li className="p-4 border-b border-gray-700">Submenu 1</li>
          <li className="p-4 border-b border-gray-700">Submenu 2</li>
          <li className="p-4">Submenu 3</li>
        </ul>
      </div>
